...
use bevy::{
    ...
    render::{
        ...
        render_resource::{
            ...
            RenderPassDescriptor, SamplerDescriptor, ShaderType,
        },
...
impl ViewNode for PostProcessNode {
    ...
    fn run(
        ...
        let post_process_pipeline = world.resource::<RenderOitPipeline>();
...
#[derive(Resource)]
pub struct RenderOitPipeline {
    pub layout: BindGroupLayout,
    pub pipeline_id: CachedRenderPipelineId,
}

impl FromWorld for RenderOitPipeline {
